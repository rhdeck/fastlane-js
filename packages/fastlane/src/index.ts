...
type DownloadUniversalApkFromGooglePlayOptions = {
  /**
   * The package name of the application to use
   */
  packageName: string;
...
/** @ignore */
type convertedDownloadUniversalApkFromGooglePlayOptions = {
  package_name: string;
  version_code?: any;
  json_key?: string;
  json_key_data?: string;
...
/** @ignore Convert DownloadUniversalApkFromGooglePlayOptions to the shape used by the Fastlane service
 */
function convertDownloadUniversalApkFromGooglePlayOptions(
  options: DownloadUniversalApkFromGooglePlayOptions
): convertedDownloadUniversalApkFromGooglePlayOptions {
  const temp: convertedDownloadUniversalApkFromGooglePlayOptions = {
    package_name: options.packageName,
    destination: options.destination,
  };
  ...
  if (typeof options.rootUrl !== "undefined")
    temp["root_url"] = options.rootUrl;
  if (typeof options.timeout !== "undefined") temp["timeout"] = options.timeout;
  if (typeof options.certificateSha256Hash !== "undefined")
    temp["certificate_sha256_hash"] = options.certificateSha256Hash;
  return temp;
}
...
type convertedGetProvisioningProfileOptions = {
  ...
  cached_certificates?: any;
  cached_devices?: any;
  cached_bundle_ids?: any;
  cached_profiles?: any;
};
...
function convertGetProvisioningProfileOptions(
  ...
  if (typeof options.cachedCertificates !== "undefined")
    temp["cached_certificates"] = options.cachedCertificates;
  if (typeof options.cachedDevices !== "undefined")
    temp["cached_devices"] = options.cachedDevices;
  if (typeof options.cachedBundleIds !== "undefined")
    temp["cached_bundle_ids"] = options.cachedBundleIds;
  if (typeof options.cachedProfiles !== "undefined")
    temp["cached_profiles"] = options.cachedProfiles;
  return temp;
}
...
function convertSonarOptions(options: SonarOptions): convertedSonarOptions {
  ...
  if (typeof options.sonarToken !== "undefined")
    temp["sonar_token"] = options.sonarToken;
...
function convertSpmOptions(options: SpmOptions): convertedSpmOptions {
  const temp: convertedSpmOptions = {
    ...
    verbose: options.verbose,
    simulator_arch: options.simulatorArch,
  };
  if (typeof options.enableCodeCoverage !== "undefined")
    temp["enable_code_coverage"] = options.enableCodeCoverage;
  if (typeof options.scratchPath !== "undefined")
    temp["scratch_path"] = options.scratchPath;
  if (typeof options.buildPath !== "undefined")
    temp["build_path"] = options.buildPath;
  if (typeof options.packagePath !== "undefined")
    temp["package_path"] = options.packagePath;
  ...
  if (typeof options.xcprettyArgs !== "undefined")
    temp["xcpretty_args"] = options.xcprettyArgs;
  if (typeof options.simulator !== "undefined")
    temp["simulator"] = options.simulator;
  return temp;
}
...
See https://developers.google.com/android-publisher/api-ref/rest/v3/generatedapks/list
    ...
    * @return The path to the downloaded Universal APK. The action will raise an exception if it failed to find or download the APK in Google Play 
    */
  async downloadUniversalApkFromGooglePlay(
    options: DownloadUniversalApkFromGooglePlayOptions
  ): Promise<any> {
    const out = await this.doAction(
      "download_universal_apk_from_google_play",
      convertDownloadUniversalApkFromGooglePlayOptions(options)
    );
    return out;
  }
